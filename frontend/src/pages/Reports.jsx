...
//         return Math.max(
//             ...categoryData.map((item) => Number(item.totalAmount || 0)),
//             1
//         );
//     }, [categoryData]);
...
//                 <div className="mx-auto flex max-w-xl flex-col items-center justify-center rounded-3xl bg-white p-10 text-center shadow-sm">
...
//                                     const profit = Number(crop.profitLoss || 0);
//                                     const income = Number(crop.totalIncome || 0);
//                                     const expenses = Number(crop.totalExpenses || 0);
